...
import org.team4u.sql.builder.entity.processor.JpaEntityProcessor;

/**
 * @author Jay Wu
 */
public class JpaSqlBuilders extends SqlBuilders {

    private static EntityManager entityManager = new EntityManager(new JpaEntityProcessor());
